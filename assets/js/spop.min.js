...
!(function () {
  ...
  var s,
    ...
    u = function (o, p) {
      if (
        ...
        s = { template: o, style: p || i.style };
      else {
        if ("object" != typeof o)
          return console.error("Invalid arguments."), !1;
        s = o;
      }
      (this.opt = e(i, s)),
        t("spop--" + this.opt.group) &&
          this.remove(t("spop--" + this.opt.group)),
        this.open();
    };
  (u.prototype.create = function (o) {
    (p = t(this.getPosition("spop--", this.opt.position))),
      (n = this.opt.icon
        ? '<i class="spop-icon ' +
          this.getStyle("spop-icon--", this.opt.style) +
          '"></i>'
        : ""),
      (r =
      ...
      p ||
        ...
        this.popContainer.setAttribute(
          "class",
          "spop-container " + this.getPosition("spop--", this.opt.position)
        ),
        this.popContainer.setAttribute(
          "id",
      ...
      this.pop.setAttribute(
        "class",
        "spop spop--out spop--in " + this.getStyle("spop--", this.opt.style)
      ),
      this.opt.group &&
        "string" == typeof this.opt.group &&
    ...
    (u.prototype.getStyle = function (t, o) {
      return (
        (c = { success: "success", error: "error", warning: "warning" }),
        t + (c[o] || "info")
      );
    }),
    ...
    (u.prototype.close = function () {
      this.opt.autoclose &&
        "number" == typeof this.opt.autoclose &&
        (this.autocloseTimer = setTimeout(
          this.remove.bind(this, this.pop),
          this.opt.autoclose
        )),
